...
## Установка и запуск
Для работы с программой достаточно скачать и запустить файл `MathCalculators.exe`.
...
### Многочлены
Программа поддерживает следующий формат ввода многочленов:
- **Стандартный вид со степенями:** `<aₙ>x^n + ... + <aᵣ>x^r + ... + <a₁>x + <a₀>`
